...
2. Click on the OnWebChat link to take you to the OnWebChat login webpage.
3. Sign in or create a new account (If you're not already signed in to OnWebChat).
4. Go to Settings page and copy the "Chat Id".
5. Paste the "Chat Id" to the field and Click "Save Changes".
